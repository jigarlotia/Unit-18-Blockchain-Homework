...
@dataclass
class Record:
    # Define an attribute named `sender` with a type of `str`.
    sender: str
    # Define an attribute named `receiver` with a type of `str`.
    receiver: str
...
amount = st.number_input(label="Enter Amount", format='%.2f')



if st.button("Add Block"):
    #Create an instance of the record and set the values
